              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(fit: BoxFit.cover, image: AssetImage("assets/authcover.jpeg")),
                  ),
                ),
                Container(
                  // welcomes4V (814:7008)
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FloatingActionButton.extended(
        ...
        onPressed: () {
          Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => FoodList()), (Route<dynamic> route) => false);
        },
      ),
    );
  }
